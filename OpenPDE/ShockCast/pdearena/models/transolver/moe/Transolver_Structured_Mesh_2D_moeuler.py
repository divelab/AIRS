...
class Expert_block(nn.Module):
    ...
    def forward(self, fx, emb):
        ...
        fx = dt_emb_mlp * self.mlp(modulate(self.ln_2(fx), shift_mlp, scale_mlp))
        return fx
...
class Transolver_block(nn.Module):
    ...
    def __init__(
        ...
        expert_init = lambda: Expert_block(num_heads=num_heads,
        ...
        self.gate = MLP(1, hidden_dim * mlp_ratio, num_experts, n_layers=0, res=False, act=act)
        if self.last_layer:
