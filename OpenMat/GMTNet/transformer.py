...
class ComformerConvEqui(nn.Module):
    def __init__(
        ...
        irrep_seq = [
            ...
            '1x0e + 1x0o + 1x1e + 1x1o + 1x2e + 1x2o + 1x3e + 1x3o', # output
        ...
        # self.nlayer_4 = TensorProductConvLayer(
        #     in_irreps=irrep_seq[3],
        #     sh_irreps=self.sh,
        #     out_irreps=irrep_seq[4],
        #     n_edge_features=edge_dim,
        #     residual=False
        # )
        # self.nlayer_5 = TensorProductConvLayer(
        #     in_irreps=irrep_seq[4],
        #     sh_irreps=self.sh,
        #     out_irreps=irrep_seq[5],
        #     n_edge_features=edge_dim,
        #     residual=False
        # )
    ...
    def forward(self, data, node_feature: Union[Tensor, PairTensor], edge_index: Adj, edge_feature: Union[Tensor, PairTensor]):
        ...
        # node_feature = self.nlayer_4(node_feature, edge_index, edge_feature, edge_irr)
        # node_feature = self.nlayer_5(node_feature, edge_index, edge_feature, edge_irr)
