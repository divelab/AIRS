...
if __name__ == "__main__":
    from Pyg3BPA import Pyg3BPA

    name = "train_300K"
    pyg_dataset = Pyg3BPA(root="./3bpa/pyg_dataset/", name=name)
    ...
    print(train_dataset)
    dataset = Preprocess3BPA(train_dataset, cutoff=5)
    print(dataset)
    print(dataset[0])
