...
if __name__ == '__main__':
    ...
    parser.add_argument('--save_path', default='gpt_p1',
    ...
    for idx, first_token in enumerate(first_tokens):
        ...
        samples = generate_sample(model, tokenizer, batch_first_tokens, max_len, top_k=args.top_k, temp=args.temp, beam_size=None)
