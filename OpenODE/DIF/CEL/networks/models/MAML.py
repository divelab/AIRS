...
from .MAML_utils.utils import clone_module, update_module

# Adapted from package learn2learn
...
class MAML(nn.Module, ModelClass):
    """
    [[Source]](https://github.com/learnables/learn2learn/blob/master/learn2learn/algorithms/maml.py)
    ...
    **Example**
    ...
    def clone(self, first_order=None, allow_unused=None, allow_nograd=None):
        ...
        * **allow_nograd** (bool, *optional*, default=False) - Whether to allow adaptation with
        ...
        if allow_nograd is None:
            allow_nograd = self.allow_nograd
        return MAML(self.y_channels,
                    self.W_channels,
                    self.dfunc_hidden_channels,
                    self.depth_enc,
                    self.num_envs,
                    lr=self.lr,
                    module=clone_module(self.module),
