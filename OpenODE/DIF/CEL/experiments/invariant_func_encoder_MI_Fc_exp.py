...
class InvariantFuncEncMIFcExperiment(ExpClass):
    ...
    def train_batch(self, data, input_length, run_type) -> dict:
        ...
        if self.inv_type == 'Invariant':
            # -- max I(F_C;Y) --
            pred_fc_loss = F.mse_loss(pred_dydt, dydt)
            ...
            E_disFc_loss = F.cross_entropy(pred_E, env)
            ...
            training_loss = {'pred_fc': {'weight': self.lambda_pred_fc, 'value': pred_fc_loss},
